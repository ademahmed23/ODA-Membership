...
@section('filterAction', route('zone16.index'))
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                                    ...
                                    @can('zone16-edit')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('zone16.edit', $report->id) }}">Edit</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('zone16-delete')
                                        <li>
                                            <form action="{{ route('zone16.destroy', $report->id) }}" method="POST"
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a class="dropdown-item text-warning"
                                                href="{{ route('zone16.pay', $report->id) }}">Pay</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
