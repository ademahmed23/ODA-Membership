...
@section('model', 'Wallagga Lixaa')
@section('count', $count)
@section('title', 'Wallagga Lixaa')
@section('insert', 'Wallagga Lixaa')
@section('icons', 'layout')
@section('route', route('zone21.create'))
@section('import', route('zone21.import'))
@section('filterAction', route('zone21.index'))
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                                    ...
                                    @can('zone21-edit')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('zone21.edit', $report->id) }}">Edit</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('zone21-delete')
                                        <li>
                                            <form action="{{ route('zone21.destroy', $report->id) }}" method="POST"
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a class="dropdown-item text-warning"
                                                href="{{ route('zone21.pay', $report->id) }}">Pay</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
