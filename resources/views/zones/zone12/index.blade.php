                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                                    ...
                                    @can('zone12-edit')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('zone12.edit', $report->id) }}">Edit</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('zone12-delete')
                                        <li>
                                            <form action="{{ route('zone12.destroy', $report->id) }}" method="POST"
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a class="dropdown-item text-warning"
                                                href="{{ route('zone12.pay', $report->id) }}">Pay</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
