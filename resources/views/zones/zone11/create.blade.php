...
<form method="POST" action="{{ route('zone11.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="Education_level" name="Education_level" placeholder="Enter Education Level">
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
