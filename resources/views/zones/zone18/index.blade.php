...
@section('model', 'Shawaa Kibba Lixaa')
@section('count', $count)
@section('title', 'Shawaa Kibba Lixaa')
@section('insert', 'Shawaa Kibba Lixaa')
@section('icons', 'layout')
@section('route', route('zone18.create'))
@section('import', route('zone18.import'))
@section('filterAction', route('zone18.index'))
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                                    ...
                                    @can('zone18-edit')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('zone18.edit', $report->id) }}">Edit</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('zone18-delete')
                                        <li>
                                            <form action="{{ route('zone18.destroy', $report->id) }}" method="POST"
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a class="dropdown-item text-warning"
                                                href="{{ route('zone18.pay', $report->id) }}">Pay</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
