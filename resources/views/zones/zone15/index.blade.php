...
@section('model', 'Qeellam Wallaggaa')
@section('count', $count)
@section('title', 'Qeellam Wallaggaa')
@section('insert', 'Qeellam Wallaggaa')
@section('icons', 'layout')
@section('route', route('zone15.create'))
@section('import', route('zone15.import'))
@section('filterAction', route('zone15.index'))
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                                    ...
                                    @can('zone15-edit')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('zone15.edit', $report->id) }}">Edit</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('zone15-delete')
                                        <li>
                                            <form action="{{ route('zone15.destroy', $report->id) }}" method="POST"
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a class="dropdown-item text-warning"
                                                href="{{ route('zone15.pay', $report->id) }}">Pay</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
