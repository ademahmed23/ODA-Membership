...
@section('model', 'Wallagga Bahaa')
@section('count', $count)
@section('title', 'Wallagga Bahaa')
@section('insert', 'Wallagga Bahaa')
@section('icons', 'layout')
@section('route', route('zone20.create'))
@section('import', route('zone20.import'))
@section('filterAction', route('zone20.index'))
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                                    ...
                                    @can('zone20-edit')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('zone20.edit', $report->id) }}">Edit</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('zone20-delete')
                                        <li>
                                            <form action="{{ route('zone20.destroy', $report->id) }}" method="POST"
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a class="dropdown-item text-warning"
                                                href="{{ route('zone20.pay', $report->id) }}">Pay</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
