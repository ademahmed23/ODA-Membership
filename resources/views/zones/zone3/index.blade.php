...
@section('insert', 'Baalee')
@section('icons', 'layout')
@section('route', route('zone3.create'))
@section('import', route('zone3.import'))
@section('filterAction', route('zone3.index'))
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                                    ...
                                    @can('zone1-edit')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('zone1.edit', $report->id) }}">Edit</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('zone1-delete')
                                        <li>
                                            <form action="{{ route('zone1.destroy', $report->id) }}" method="POST"
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a class="dropdown-item text-warning"
                                                href="{{ route('zone1.pay', $report->id) }}">Pay</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
