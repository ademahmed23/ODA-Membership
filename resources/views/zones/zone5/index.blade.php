...
@section('filterAction', route('zone5.index'))
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                                    ...
                                    @can('zone5-edit')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('zone5.edit', $report->id) }}">Edit</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('zone5-delete')
                                        <li>
                                            <form action="{{ route('zone5.destroy', $report->id) }}" method="POST"
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a class="dropdown-item text-warning"
                                                href="{{ route('zone5.pay', $report->id) }}">Pay</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
