<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('front/images/logo (1).png')}}" />
    ...
    <link rel="stylesheet" href="{{ asset('dash/assets/vendor/css/theme-default.css')}}" class="template-customizer-theme-css" />
