...
<div class="sidebar" data-color="orange" data-background-color="white" data-image="{{ asset('material/img/sidebar-1.jpg') }}">
  ...
  -->
    <div class="logo">
        <a href="https://Skylinkict.com/" class="simple-text logo-normal">
            Skylink ICT
        </a>
    </div>
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <li class="nav-item {{ Request::is('zone1') ? 'active' :'' }}">

                <a class="nav-link" href="{{ route('zone1.index') }}">


                    <i style="color:black;" class="material-icons">groups</i>

                    <p style="color:black;">Zone One</p>
                </a>
            </li>
