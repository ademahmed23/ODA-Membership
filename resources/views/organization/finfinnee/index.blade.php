...
@section('route',route('finfinnee.create'))
@section('import',route('finfinnee.import'))
@section('filterAction', route('finfinnee.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('finfinnee.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        {{-- Delete --}}
                        @can('finfinnee-delete')
                        <li>
                            <form action="{{ route('finfinnee.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('finfinnee.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
