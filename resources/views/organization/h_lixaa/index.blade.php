...
@section('insert','h_lixaa')
@section('icons','layout')
@section('route',route('h_lixaa.create'))
@section('import',route('h_lixaa.import'))
@section('filterAction', route('h_lixaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('h_lixaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('h_lixaa-delete')
                        <li>
                            <form action="{{ route('h_lixaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('h_lixaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
