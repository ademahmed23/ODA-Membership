...
@section('model','Hoorroo Guduruu Wallaggaa')
@section('count',$count)
@section('title','Hoorroo Guduruu Wallaggaa')
@section('insert','hoorroo')
@section('icons','layout')
@section('route',route('hoorroo.create'))
@section('import',route('hoorroo.import'))
@section('filterAction', route('hoorroo.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('hoorroo.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('hoorroo-delete')
                        <li>
                            <form action="{{ route('hoorroo.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('hoorroo.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
