...
@section('route',route('booranaa.create'))
@section('import',route('booranaa.import'))
@section('filterAction', route('booranaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('booranaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('booranaa-delete')
                        <li>
                            <form action="{{ route('booranaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('booranaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
