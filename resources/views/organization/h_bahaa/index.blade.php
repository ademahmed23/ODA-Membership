...
@section('insert','h_bahaa')
@section('icons','layout')
@section('route',route('h_bahaa.create'))
@section('import',route('h_bahaa.import'))
@section('filterAction', route('h_bahaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('h_bahaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('h_bahaa-delete')
                        <li>
                            <form action="{{ route('h_bahaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('h_bahaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
