...
@section('route',route('jimmaa.create'))
@section('import',route('jimmaa.import'))
@section('filterAction', route('jimmaa.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('jimmaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('jimmaa-delete')
                        <li>
                            <form action="{{ route('jimmaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('jimmaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
