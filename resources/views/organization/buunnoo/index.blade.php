...
@section('insert','buunnoo')
@section('icons','layout')
@section('route',route('buunnoo.create'))
@section('import',route('buunnoo.import'))
@section('filterAction', route('buunnoo.index'))
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('buunnoo.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        @can('buunnoo-delete')
                        <li>
                            <form action="{{ route('buunnoo.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('buunnoo.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
