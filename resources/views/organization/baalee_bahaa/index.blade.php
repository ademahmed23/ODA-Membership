...
@section('route',route('baalee_bahaa.create'))
@section('import',route('baalee_bahaa.import'))
@section('filterAction', route('baalee_bahaa.index'))
            ...
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $report->id }}">
                        ...
                        {{-- Edit --}}
                        @can('baalee_bahaa-edit')
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('baalee_bahaa.edit', $report->id) }}">
                                Edit
                            </a>
                        </li>
                        @endcan
                        ...
                        {{-- Delete --}}
                        @can('baalee_bahaa-delete')
                        <li>
                            <form action="{{ route('baalee_bahaa.destroy', $report->id) }}"
                                  method="POST"
                        ...
                        <li>
                            ...
                            @else
                                <a class="dropdown-item text-warning"
                                   href="{{ route('baalee_bahaa.pay', $report->id) }}">
                                    Pay
                                </a>
                            @endif
                        </li>
