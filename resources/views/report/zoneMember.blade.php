        ...
        <div class="card-body">
            <div class="row">
                <div class="col-6 mb-3">
                    <form action="zoneMember-report" method="POST" enctype="multipart/form-data" style="display: flex; align-items: center;">
                        @csrf
                        <label for="zone" style="margin-right: 10px;">Zone</label>
                        <select name="zone" id="zone" class="form-control dynamic" data-dependent="woreda" style="display: inline-block;width:35%;margin-right:10px;">
                ...
                <div class="col-6 mb-3 align-content-end" style="text-align: right;">
                    <a href="zoneMember-export/{{ $zone }}/{{ $woreda }}" class="btn btn-sm btn-success">Download</a>
                </div>
                @endif
