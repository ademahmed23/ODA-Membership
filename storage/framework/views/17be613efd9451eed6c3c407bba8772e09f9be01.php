...
<?php $__env->startSection('model','Arsii'); ?>
<?php $__env->startSection('count',$count); ?>
<?php $__env->startSection('title','Arsii'); ?>
<?php $__env->startSection('insert','Arsii'); ?>
<?php $__env->startSection('icons','layout'); ?>
<?php $__env->startSection('route',route('arsii.create')); ?>
<?php $__env->startSection('import',route('arsii.import')); ?>
<?php $__env->startSection('filterAction', route('arsii.index')); ?>
...
<?php $__env->startSection('exportRoute', url('zoneMember-export/arsii/' . $woreda)); ?>
...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo e($report->paymemt); ?></td>
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown<?php echo e($report->id); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('arsii-edit')): ?>
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('arsii.edit', $report->id)); ?>">Edit</a>
                        </li>
                        <?php endif; ?>

                        
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('arsii-delete')): ?>
                        <li>
                            <form action="<?php echo e(route('arsii.destroy', $report->id)); ?>" method="POST" onsubmit="return confirm('Are you sure?');">
                                <?php echo csrf_field(); ?>
                        ...
                        <li>
                            ...
                            <?php else: ?>
                                <a class="dropdown-item text-warning" href="<?php echo e(route('arsii.pay', $report->id)); ?>">Pay</a>
                            <?php endif; ?>
                        </li>
                    </ul>
                </div>
...
<?php echo $__env->make('layouts.components.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ODA-Membership\resources\views/organization/arsii/index.blade.php ENDPATH**/ ?>