                                  ...
                                  <div class="card-body">
                                      <div class="card-title d-flex align-items-start justify-content-between">
                                          <div class="avatar flex-shrink-0">
                                              ...
                                              <i class="bx bxs-<?php echo $__env->yieldContent('icons'); ?>" style="font-size: 2.5em;color:green;"></i>
                              ...
                              <div class="card-body">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-6 mb-3">
                                          <form method="GET" action="<?php echo $__env->yieldContent('filterAction'); ?>" class="mb-3">
                                              <div class="row">
                                                  <div class="col-6 mb-3">
                                                      <select name="<?php echo $__env->yieldContent('filterName', 'woreda'); ?>" class="form-control" required>
                                                          <option value="">-- Select <?php echo $__env->yieldContent('filterLabel', 'Woreda'); ?> --</option>
                                                          <?php $__currentLoopData = $woredas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                              <option value="<?php echo e($w); ?>"
                                                                  <?php echo e(($selectedWoreda ?? '') == $w ? 'selected' : ''); ?>>
                                                                  <?php echo e($w); ?></option>
                                                  ...
                                                  <div class="col-md-3">
                                                      <button type="submit"
                                                          class="btn btn-success mb-2"><?php echo $__env->yieldContent('filterButton', 'Show Data'); ?></button>
                                                  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ODA-IT\Documents\GitHub\ODA-Membership\resources\views/layouts/components/index.blade.php ENDPATH**/ ?>