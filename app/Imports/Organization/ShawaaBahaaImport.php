...
class ShawaaBahaaImport implements ToCollection
{
    protected $id;
    ...
    public function collection(Collection $rows)
    {
        ...
        if ($error != null) {
            return redirect()->route('sh_bahaa.index')->with('delete', $error);
        } else {
            return redirect()->route('sh_bahaa.index')->with('success', 'Data imported successfully');
        }
    }
}
