...
class JimmaaImport implements ToCollection
{
    protected $id;
    ...
    public function collection(Collection $rows)
    {
        ...
        if ($error != null) {
            return redirect()->route('jimmaa.index')->with('delete', $error);
        } else {
            return redirect()->route('jimmaa.index')->with('success', 'Data imported successfully');
        }
    }
}
