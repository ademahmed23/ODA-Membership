...
class ShawaaKibbaLixaaImport implements ToCollection
{
    protected $id;
    ...
    public function collection(Collection $rows)
    {
        ...
        if ($error != null) {
            return redirect()->route('sh_k_lixaa.index')->with('delete', $error);
        } else {
            return redirect()->route('sh_k_lixaa.index')->with('success', 'Data imported successfully');
        }
    }
}
