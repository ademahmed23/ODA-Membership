...
class ArsiiImport implements ToCollection
{
    protected $id;
    ...
    public function collection(Collection $rows)
    {
        ...
        if ($error != null) {
            return redirect()->route('arsii.index')->with('delete', $error);
        } else {
            return redirect()->route('arsii.index')->with('success', 'Data imported successfully');
        }
    }
}
