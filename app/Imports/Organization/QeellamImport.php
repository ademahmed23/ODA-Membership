...
class QeellamImport implements ToCollection
{
    protected $id;
    ...
    public function collection(Collection $rows)
    {
        ...
        if ($error != null) {
            return redirect()->route('qeellam.index')->with('delete', $error);
        } else {
            return redirect()->route('qeellam.index')->with('success', 'Data imported successfully');
        }
    }
}
