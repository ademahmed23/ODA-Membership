...
class WallaggaBahaaImport implements ToCollection
{
    protected $id;
    ...
    public function collection(Collection $rows)
    {
        ...
        if ($error != null) {
            return redirect()->route('w_bahaa.index')->with('delete', $error);
        } else {
            return redirect()->route('w_bahaa.index')->with('success', 'Data imported successfully');
        }
    }
}
