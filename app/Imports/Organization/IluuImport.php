...
class IluuImport implements ToCollection
{
    protected $id;
    ...
    public function collection(Collection $rows)
    {
        ...
        if ($error != null) {
            return redirect()->route('iluu.index')->with('delete', $error);
        } else {
            return redirect()->route('iluu.index')->with('success', 'Data imported successfully');
        }
    }
}
