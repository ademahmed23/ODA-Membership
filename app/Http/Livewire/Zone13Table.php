...
final class Zone13Table extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Zone13>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('first_name_lower', function (Zone13 $model) {
    ...
    */
    ...
    /**
     * PowerGrid Zone13 Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->target('_self')
                ->route('zone13.edit', ['zone13' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bx bx-trash me-1')
                ->target('_self')
                ->route('zone13.destroy', ['zone13' => 'id'])
                ->method('delete'),
    ...
    */
    ...
    public function actionRules(): array
    {
        return [
            ...
            //->hide(),
            Rule::button('edit')
                ->when(fn () => Auth::user()->cannot('zone13-edit'))
                ->hide(),

            Rule::button('delete')
                ->when(fn () => Auth::user()->cannot('zone13-delete'))
                ->hide(),
            Rule::button('pay')
                ->when(fn ($zone13) => ZoneMemberPay::where('member_id', $zone13->id)->where('model', 'zone13')->whereMonth('date', now()->month)->whereYear('date', now()->year)->exists())
                ->hide(),
            Rule::button('paid')
                ->when(fn ($zone13) => !ZoneMemberPay::where('member_id', $zone13->id)->where(
                    'model',
                    'zone13'
                )->whereMonth(
                    'date',
