...
final class HonorableTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Honorable>
     */
    public function datasource(): Builder
    {
        return Honorable::query();
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('first_name_lower', function (Honorable $model) {
    ...
    */
    ...
    /**
     * PowerGrid Honorable Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->target('_self')
                ->route('honorable.edit', ['honorable' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bx bx-trash me-1')
                ->target('_self')
                ->route('honorable.destroy', ['honorable' => 'id'])
                ->method('delete'),
            ...
            Button::make('pay', 'Pay')
                ...
                ->target('_self')
                ->route('honorable.pay', ['honorable' => 'id'])
        ];
    }
    ...
    */
    ...
    /**
     * PowerGrid Honorable Action Rules.
     *
    ...
    public function actionRules(): array
    {
        return [
            ...
            Rule::button('delete')
                ...
                ->hide(),
            Rule::button('pay')
                ->when(fn ($honorable) => HonorableMemberPay::where('member_id', $honorable->id)->whereMonth('date', now()->month)->whereYear('date', now()->year)->exists())
                ->hide(),
            Rule::button('paid')
                ->when(fn ($honorable) => !HonorableMemberPay::where('member_id', $honorable->id)->whereMonth(
                    'date',
                    now()->month
