...
final class Zone2Table extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Zone2>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('first_name_lower', function (Zone2 $model) {
    ...
    */
    ...
    /**
     * PowerGrid Zone2 Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->target('_self')
                ->route('zone2.edit', ['zone2' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bx bx-trash me-1')
                ->target('_self')
                ->route('zone2.destroy', ['zone2' => 'id'])
                ->method('delete'),
    ...
    */
    ...
    public function actionRules(): array
    {
        return [
            ...
            //->hide(),
            Rule::button('edit')
                ->when(fn () => Auth::user()->cannot('zone2-edit'))
                ->hide(),

            Rule::button('delete')
                ->when(fn () => Auth::user()->cannot('zone2-delete'))
                ->hide(),
            Rule::button('pay')
                ...
                ->hide(),
            Rule::button('paid')
                ->when(fn ($zone2) => !ZoneMemberPay::where('member_id', $zone2->id)->where(
                    'model',
                    'zone2'
                )->whereMonth(
                    'date',
