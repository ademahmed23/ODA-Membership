...
final class Zone21Table extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Zone21>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('first_name_lower', function (Zone21 $model) {
    ...
    */
    ...
    /**
     * PowerGrid Zone21 Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->target('_self')
                ->route('zone21.edit', ['zone21' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bx bx-trash me-1')
                ->target('_self')
                ->route('zone21.destroy', ['zone21' => 'id'])
                ->method('delete'),
    ...
    */
    ...
    public function actionRules(): array
    {
        return [
            ...
            //->hide(),
            Rule::button('edit')
                ->when(fn () => Auth::user()->cannot('zone21-edit'))
                ->hide(),

            Rule::button('delete')
                ->when(fn () => Auth::user()->cannot('zone21-delete'))
                ->hide(),
            Rule::button('pay')
                ->when(fn ($zone21) => ZoneMemberPay::where('member_id', $zone21->id)->where('model', 'zone21')->whereMonth('date', now()->month)->whereYear('date', now()->year)->exists())
                ->hide(),
            Rule::button('paid')
                ->when(fn ($zone21) => !ZoneMemberPay::where('member_id', $zone21->id)->where(
                    'model',
                    'zone21'
                )->whereMonth(
                    'date',
