...
final class Zone18Table extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Zone18>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('first_name_lower', function (Zone18 $model) {
    ...
    */
    ...
    /**
     * PowerGrid Zone18 Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->target('_self')
                ->route('zone18.edit', ['zone18' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bx bx-trash me-1')
                ->target('_self')
                ->route('zone18.destroy', ['zone18' => 'id'])
                ->method('delete'),
    ...
    */
    ...
    public function actionRules(): array
    {
        return [
            ...
            //->hide(),
            Rule::button('edit')
                ->when(fn () => Auth::user()->cannot('zone18-edit'))
                ->hide(),

            Rule::button('delete')
                ->when(fn () => Auth::user()->cannot('zone18-delete'))
                ->hide(),
            Rule::button('pay')
                ->when(fn ($zone18) => ZoneMemberPay::where('member_id', $zone18->id)->where('model', 'zone18')->whereMonth('date', now()->month)->whereYear('date', now()->year)->exists())
                ->hide(),
            Rule::button('paid')
                ->when(fn ($zone18) => !ZoneMemberPay::where('member_id', $zone18->id)->where(
                    'model',
                    'zone18'
                )->whereMonth(
                    'date',
