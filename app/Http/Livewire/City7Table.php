...
final class City7Table extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\City7>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('first_name_lower', function (City7 $model) {
    ...
    */
    ...
    /**
     * PowerGrid City7 Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->target('_self')
                ->route('city7.edit', ['city7' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bx bx-trash me-1')
                ->target('_self')
                ->route('city7.destroy', ['city7' => 'id'])
                ->method('delete'),
    ...
    */
    ...
    public function actionRules(): array
    {
        return [
            ...
            //->hide(),
            Rule::button('edit')
                ->when(fn () => Auth::user()->cannot('city7-edit'))
                ->hide(),

            Rule::button('delete')
                ->when(fn () => Auth::user()->cannot('city7-delete'))
                ->hide(),
            Rule::button('pay')
                ->when(fn ($city2) => CityMemberPay::where('member_id', $city2->id)->where('model', 'city2')->whereMonth(
                    'date',
                    now()->month
            ...
            Rule::button('paid')
                ->when(fn ($city7) => !CityMemberPay::where('member_id', $city7->id)->where('model', 'city7')->whereMonth(
                    'date',
                    now()->month
                )->whereYear('date', now()->year)->exists())
                ->hide(),
