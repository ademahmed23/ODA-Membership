...
final class RegionalTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Regional>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('first_name_lower', function (Regional $model) {
    ...
    */
    ...
    /**
     * PowerGrid Regional Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->target('_self')
                ->route('regional.edit', ['regional' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bx bx-trash me-1')
                ->target('_self')
                ->route('regional.destroy', ['regional' => 'id'])
                ->method('delete'),
            ...
            Button::make('pay', 'Pay')
                ...
                ->target('_self')
                ->route('regional.pay', ['regional' => 'id'])
        ];
    }
    ...
    */
    ...
    /**
     * PowerGrid Regional Action Rules.
     *
    ...
    public function actionRules(): array
    {
        return [
            ...
            //->hide(),
            Rule::button('edit')
                ->when(fn () => Auth::user()->cannot('regionalRegional-edit'))
                ->hide(),

            Rule::button('delete')
                ->when(fn () => Auth::user()->cannot('regionalRegional-delete'))
                ->hide(),
            Rule::button('pay')
                ->when(fn ($regional) => RegionMemberPay::where('member_id', $regional->id)->whereMonth('date', now()->month)->whereYear('date', now()->year)->exists())
                ->hide(),

            Rule::button('paid')
                ->when(fn ($regional) => !RegionMemberPay::where('member_id', $regional->id)->whereMonth(
                    'date',
                    now()->month
