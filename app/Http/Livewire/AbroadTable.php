...
final class AbroadTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Abroad>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('first_name_lower', function (Abroad $model) {
    ...
    */
    ...
    /**
     * PowerGrid Abroad Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->target('_self')
                ->route('abroad.edit', ['abroad' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bx bx-trash me-1')
                ->target('_self')
                ->route('abroad.destroy', ['abroad' => 'id'])
                ->method('delete'),
    ...
    */
    ...
    public function actionRules(): array
    {
        return [
            ...
            //->hide(),
            Rule::button('edit')
                ->when(fn () => Auth::user()->cannot('abroad-edit'))
                ->hide(),

            Rule::button('delete')
                ->when(fn () => Auth::user()->cannot('abroad-delete'))
                ->hide(),
            Rule::button('pay')
                ->when(fn ($abroad) => AbroadMemberPay::where('member_id', $abroad->id)->whereMonth('date', now()->month)->whereYear('date', now()->year)->exists())
                ->hide(),
            Rule::button('paid')
                ->when(fn ($abroad) => !AbroadMemberPay::where('member_id', $abroad->id)->whereMonth(
                    'date',
                    now()->month
